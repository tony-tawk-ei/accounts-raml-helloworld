  ...
  stages {
    ...
    stage('Deploy CloudHub') {
      ...
      steps {
        ...
        sh 'mvn deploy -DmuleDeploy -Dcloud.env=INT -DcloudhubAppName=accounts-raml-helloworld -Dmule.version=4.1.4 -Dcloud.user=${ANYPOINT_CREDENTIALS_USR} -Dcloud.password=${ANYPOINT_CREDENTIALS_PSW}'      	
      }
    }
  }
}